...
class SigninsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signin" do
    assert_difference('Signin.count') do
      post signins_url, params: { signin: { email: @signin.email, password: @signin.password } }
    end
  ...
  test "should update signin" do
    patch signin_url(@signin), params: { signin: { email: @signin.email, password: @signin.password } }
